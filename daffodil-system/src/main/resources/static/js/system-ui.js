...
(function ($) {
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
                ...
                $('#' + options.id).bootstrapTable({
                    ...
                    singleSelect: options.singleSelect					// 设置为记录单选/多选
                });
            },
            // 查询条件
    		...
    		exportExcel: function(formId) {
    			$.modal.confirm("确定导出所有" + $.table._option.modalName + "吗？", function() {
	    			...
	    			$.get($.table._option.exportUrl, $("#" + currentId).serializeArray(), function(result) {
            ...
            // 根据键值查询数据
            selectDatasByColumn : function(column, value){
            	var datas = $.map($.btTable.bootstrapTable('getData'), function (row) {
        	        if(row[column] == value){
        	        	return row;
        	        }
        	    });
        ...
        operate: {
            ...
            // 新增信息
            add: function(id) {
                $.modal.open("新增" + $.table._option.modalName, $.operate.addUrl(id));
            },
            // 新增信息，以tab页展现
            addTab: function (id) {
                $.modal.openTab("新增" + $.table._option.modalName, $.operate.addUrl(id));
            },
            // 新增信息 全屏
            addFull: function(id) {
        ...
        tree: {
        	...
        	hideAllNode: function(nodes) {
        	    var tree = $.fn.zTree.getZTreeObj(options.id);
